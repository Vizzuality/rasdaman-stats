...
```ssh
git clone https://github.com/Vizzuality/rasdaman-stats
cd rasdaman-stats
```

2. Run the rasdaman-stats.sh shell script in development mode.

```ssh
./rasdaman-stats.sh develop
```
